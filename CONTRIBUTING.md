# Contributing to GrimnatorAC

Thank you for your interest in contributing to GrimnatorAC. This document outlines the guidelines for
making pull
...
- **Compatibility**
  ...
  the [supported environments](https://github.com/GrimnatorAC/GrimnatorAC/wiki/Supported-environments) (Spigot, Paper, Folia, Fabric, etc.)
...
- GrimnatorAC is built using [Gradle](https://gradle.org/) kotlin scripts.
...
- Refer to the [Wiki](https://github.com/GrimnatorAC/GrimnatorAC/wiki) for project documentation.
