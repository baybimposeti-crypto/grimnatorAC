package com.grimnatorac.platform.fabric.sender;
...
public class FabricSenderFactory extends SenderFactory<CommandSourceStack> {
    ...
    private final AbstractFabricPlatformServer platformServer = GrimnatorACFabricLoaderPlugin.LOADER.getPlatformServer();
    private final IFabricMessageUtil fabricMessageUtils = GrimnatorACFabricLoaderPlugin.LOADER.getFabricMessageUtils();
    ...
    protected void sendMessage(CommandSourceStack sender, Component message) {
        fabricMessageUtils.sendMessage(sender, GrimnatorACFabricLoaderPlugin.LOADER.getFabricConversionUtil().toNativeText(message), false);
    }
