package com.grimnatorac.platform.fabric.player;
...
import com.grimnatorac.platform.fabric.entity.AbstractFabricGrimEntity;
import com.grimnatorac.platform.fabric.utils.PolymerHook;
import com.grimnatorac.platform.fabric.utils.convert.FabricConversionUtil;
...
public abstract class AbstractFabricPlatformPlayer extends AbstractFabricGrimEntity implements PlatformPlayer {
    ...
    public AbstractFabricPlatformPlayer(ServerPlayer player) {
        ...
        this.inventory = GrimnatorACFabricLoaderPlugin.LOADER.getPlatformPlayerFactory().getPlatformInventory(this);
    ...
    public void sendMessage(String message) {
        if (CommonGrimArguments.USE_CHAT_FAST_BYPASS.value() && user != null) {
            ...
            fabricPlayer.displayClientMessage(GrimnatorACFabricLoaderPlugin.LOADER.getFabricMessageUtils().textLiteral(message), false);
        }
    }
    ...
    public void sendMessage(Component message) {
        if (CommonGrimArguments.USE_CHAT_FAST_BYPASS.value() && user != null) {
            ...
            fabricPlayer.displayClientMessage(GrimnatorACFabricLoaderPlugin.LOADER.getFabricConversionUtil().toNativeText(message), false);
        }
    }
    ...
    public GrimEntity getVehicle() {
        ...
        return vehicle != null ? GrimnatorACFabricLoaderPlugin.LOADER.getPlatformPlayerFactory().getPlatformEntity(vehicle) : null;
    }
