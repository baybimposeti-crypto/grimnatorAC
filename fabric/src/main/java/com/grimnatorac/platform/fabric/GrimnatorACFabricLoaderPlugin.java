...
import com.grimnatorac.platform.api.manager.*;
...
import com.grimnatorac.platform.fabric.manager.*;
import com.grimnatorac.platform.fabric.player.FabricPlatformPlayerFactory;
import com.grimnatorac.platform.fabric.resolver.FabricResolverRegistrar;
import com.grimnatorac.platform.fabric.scheduler.FabricPlatformScheduler;
...
public abstract class GrimnatorACFabricLoaderPlugin implements PlatformLoader {
    public static MinecraftServer FABRIC_SERVER;
    public static GrimnatorACFabricLoaderPlugin LOADER;
    ...
    public GrimnatorACFabricLoaderPlugin(
        ...
        plugin = extensionManager.getPlugin("GrimnatorAC");
    }
