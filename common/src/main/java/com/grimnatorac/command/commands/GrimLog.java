...
public class GrimLog implements BuildableCommand {
    ...
    private static void sendLog(Sender sender, String log, String success, String failure, Consumer<String> consumer, String type) throws IOException {
        ...
        try {
            ...
            urlConn.addRequestProperty("User-Agent", "GrimnatorAC/" + GrimAPI.INSTANCE.getExternalAPI().getGrimVersion());
    ...
    public void register(CommandManager<Sender> commandManager, CloudCommandAdapter adapter) {
        Command<Sender> command = commandManager.commandBuilder("GrimnatorAC", "GrimnatorAC")
                .literal("log", "logs")
                .permission("grimnatorac.log")
