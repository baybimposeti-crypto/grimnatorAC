...
import com.grimnatorac.platform.api.PlatformPlugin;
...
import com.grimnatorac.utils.common.PropertiesUtil;
...
public class GrimDump implements BuildableCommand {
    ...
    public static JsonObject getDumpInfo() {
        ...
        versions.addProperty("GrimnatorAC", GrimAPI.INSTANCE.getExternalAPI().getGrimVersion());
    ...
    private static JsonObject getBuildInfo() {
        ...
        try {
            Properties properties = PropertiesUtil.readProperties(GrimAPI.INSTANCE.getClass(), "GrimnatorAC.properties");
