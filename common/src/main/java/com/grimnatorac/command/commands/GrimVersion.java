    ...
    private static void checkForUpdates(Sender sender) {
        try {
            ...
            HttpRequest request = HttpRequest.newBuilder()
                    ...
                    .GET()
                    .header("User-Agent", "GrimnatorAC/" + GrimAPI.INSTANCE.getExternalAPI().getGrimVersion())
            ...
            if (statusCode < 200 || statusCode >= 300) {
                ...
                sender.sendMessage(Objects.requireNonNullElseGet(msg, () -> Component.text()
                        ...
                        .append(Component.text(" Failed to check latest GrimnatorAC version. Update server responded with status code: ")
            ...
            Component msg = switch (status) {
                case AHEAD ->
                        Component.text("You are using a development version of GrimnatorAC").color(NamedTextColor.LIGHT_PURPLE);
                case UPDATED ->
                        Component.text("You are using the latest version of GrimnatorAC").color(NamedTextColor.GREEN);
                case OUTDATED -> Component.text()
                        .append(Component.text("New GrimnatorAC version found!").color(NamedTextColor.AQUA))
                        ...
                        .build();
                case UNKNOWN ->
                        Component.text("You are using an unknown GrimnatorAC version.").color(NamedTextColor.RED);
            };
            ...
            LogUtil.error("Failed to check latest GrimnatorAC version.", e);
        }
    }
    ...
    public void register(CommandManager<Sender> commandManager, CloudCommandAdapter adapter) {
        commandManager.command(
                commandManager.commandBuilder("GrimnatorAC", "GrimnatorAC")
                        .literal("version")
                        .permission("grimnatorac.version")
