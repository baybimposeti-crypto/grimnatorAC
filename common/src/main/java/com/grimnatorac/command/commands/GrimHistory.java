...
import com.grimnatorac.command.render.HistoryComponentRenderer;
...
public class GrimHistory implements BuildableCommand {
    ...
    public void register(CommandManager<Sender> commandManager, CloudCommandAdapter adapter) {
        ...
        commandManager.command(
                commandManager.commandBuilder("GrimnatorAC", "GrimnatorAC")
                        ...
                        .literal("repair")
                        .literal("check-ids")
                        .permission("grimnatorac.history.repair")
    ...
    private void registerHistoryViewBranches(
        ...
        java.util.function.Supplier<Command.Builder<Sender>> base = () -> {
            Command.Builder<Sender> b = commandManager.commandBuilder("GrimnatorAC", "GrimnatorAC")
                    .literal("history", "hist")
                    .permission("grimnatorac.history");
