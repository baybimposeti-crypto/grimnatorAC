package com.grimnatorac.utils.anticheat;
...
import com.grimnatorac.utils.reflection.GeyserUtil;
...
public class PlayerDataManager {
    ...
    public boolean shouldCheck(@NotNull User user) {
        ...
        if (user.getUUID() != null) {
            ...
            if (grimPlayer != null && grimPlayer.hasPermission("grimnatorac.exempt")) {
                exemptUsers.add(user);
                return false;
            }
