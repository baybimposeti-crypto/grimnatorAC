...
import com.grimnatorac.utils.data.tags.SyncedTag;
import com.grimnatorac.utils.data.tags.SyncedTags;
import com.grimnatorac.utils.enums.FluidTag;
import com.grimnatorac.utils.inventory.EnchantmentHelper;
...
public class BlockBreakSpeed {
    // temporary hardcode to workaround PE bug https://github.com/retrooper/packetevents/issues/1217; see https://github.com/GrimnatorAC/GrimnatorAC/issues/2117
    ...
    // another temporary hardcode for the same reasons as above; see https://github.com/GrimnatorAC/GrimnatorAC/issues/2574
    ...
    public static double getBlockDamage(GrimPlayer player, ItemStack tool, StateType block) {
        ...
        final boolean canHarvest = !block.isRequiresCorrectTool() || toolSpeedData.isCorrectToolForDrop
                // temporary hardcode to workaround PE bug https://github.com/retrooper/packetevents/issues/1217; see https://github.com/GrimnatorAC/GrimnatorAC/issues/2091
                || player.getClientVersion().isNewerThanOrEquals(ClientVersion.V_1_21_4) && HARVESTABLE_TYPES_1_21_4.contains(block)
                // same reason as above; see https://github.com/GrimnatorAC/GrimnatorAC/issues/2574
