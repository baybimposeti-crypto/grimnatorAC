package com.grimnatorac.utils.common.arguments;

import com.grimnatorac.platform.api.Platform;

import static com.grimnatorac.utils.common.arguments.ArgumentUtils.*;

public class CommonGrimArguments {

    private final static SystemArgumentFactory FACTORY = SystemArgumentFactory.Builder.of("GrimnatorAC")
            .optionModifier(builder -> builder.key("GrimnatorAC" + builder.options().getKey()))
            .supportEnv()
            .build();
    ...
    /**
     * Enables "Fast Bypass" mode for chat messages sent by GrimnatorAC.
     * <p>
