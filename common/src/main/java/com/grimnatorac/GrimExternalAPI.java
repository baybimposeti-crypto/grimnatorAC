...
import com.grimnatorac.manager.config.ConfigManagerFileImpl;
...
public class GrimExternalAPI implements GrimAbstractAPI, ConfigReloadObserver, StartableInitable {
    ...
    private static String resolveGrimVersion(GrimAPI api) {
        try {
            Properties properties = PropertiesUtil.readProperties(GrimExternalAPI.class, "GrimnatorAC.properties");
