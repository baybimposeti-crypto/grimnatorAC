...
import com.grimnatorac.utils.blockplace.BlockPlaceResult;
import com.grimnatorac.utils.blockplace.ConsumesBlockPlace;
import com.grimnatorac.utils.change.BlockModification;
import com.grimnatorac.utils.data.*;
import com.grimnatorac.utils.inventory.Inventory;
import com.grimnatorac.utils.latency.CompensatedWorld;
import com.grimnatorac.utils.math.VectorUtils;
import com.grimnatorac.utils.nmsutil.*;
...
public class CheckManagerListener extends PacketListenerAbstract {
    ...
    private static boolean isMojangStupid(GrimPlayer player, PacketReceiveEvent event, WrapperPlayClientPlayerFlying flying) {
        ...
        if (flying.hasPositionChanged() && flying.hasRotationChanged() &&
            ...
            // Additionally, only yaw/pitch matters: https://github.com/GrimnatorAC/GrimnatorAC/issues/1275#issuecomment-1872444018
