package com.grimnatorac.events.packets;
...
import com.grimnatorac.utils.functions.ObjBooleanConsumer;
...
public class PacketPlayerJoinQuit extends PacketListenerAbstract {
    ...
    public void onUserLogin(UserLoginEvent event) {
        ...
        applyToggle(platformPlayer, toggles, PlayerToggleStore.KEY_ALERTS,
                "grimnatorac.alerts", "grimnatorac.alerts.enable-on-join", "grimnatorac.alerts.enable-on-join.silent",
        ...
        applyToggle(platformPlayer, toggles, PlayerToggleStore.KEY_VERBOSE,
                "grimnatorac.verbose", "grimnatorac.verbose.enable-on-join", "grimnatorac.verbose.enable-on-join.silent",
        ...
        applyToggle(platformPlayer, toggles, PlayerToggleStore.KEY_BRANDS,
                "grimnatorac.brand", "grimnatorac.brand.enable-on-join", "grimnatorac.brand.enable-on-join.silent",
        ...
        if (platformPlayer.hasPermission("grimnatorac.spectate") && GrimAPI.INSTANCE.getConfigManager().getConfig().getBooleanElse("spectators.hide-regardless", false)) {
