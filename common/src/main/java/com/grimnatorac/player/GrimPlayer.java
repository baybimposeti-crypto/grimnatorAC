package com.grimnatorac.player;
...
import com.grimnatorac.checks.impl.packetorder.PacketOrderProcessor;
import com.grimnatorac.events.packets.CheckManagerListener;
import com.grimnatorac.manager.*;
import com.grimnatorac.manager.player.features.FeatureManagerImpl;
import com.grimnatorac.manager.player.handlers.DefaultResyncHandler;
import com.grimnatorac.manager.player.handlers.NoOpResyncHandler;
import com.grimnatorac.platform.api.player.PlatformPlayer;
import com.grimnatorac.predictionengine.EntityFluidInteraction;
import com.grimnatorac.predictionengine.MovementCheckRunner;
import com.grimnatorac.predictionengine.PointThreeEstimator;
import com.grimnatorac.predictionengine.UncertaintyHandler;
import com.grimnatorac.manager.AttackCooldownHandler;
...
import com.grimnatorac.utils.change.PlayerBlockHistory;
import com.grimnatorac.utils.collisions.datatypes.SimpleCollisionBox;
import com.grimnatorac.utils.data.*;
import com.grimnatorac.utils.data.packetentity.PacketEntity;
import com.grimnatorac.utils.data.packetentity.PacketEntityHappyGhast;
import com.grimnatorac.utils.data.packetentity.PacketEntityNautilus;
import com.grimnatorac.utils.data.packetentity.PacketEntitySelf;
import com.grimnatorac.utils.data.tags.SyncedTags;
import com.grimnatorac.utils.enums.FluidTag;
import com.grimnatorac.utils.enums.Pose;
import com.grimnatorac.utils.latency.*;
import com.grimnatorac.utils.math.GrimMath;
import com.grimnatorac.utils.math.Location;
import com.grimnatorac.utils.math.TrigHandler;
import com.grimnatorac.utils.math.Vector3dm;
import com.grimnatorac.utils.nmsutil.BlockProperties;
import com.grimnatorac.utils.nmsutil.Collisions;
import com.grimnatorac.utils.nmsutil.GetBoundingBox;
import com.grimnatorac.utils.nmsutil.Materials;
...
public class GrimPlayer implements GrimUser {
    ...
    public void updatePermissions() {
        ...
        try {
            GrimAPI.INSTANCE.getScheduler().getEntityScheduler().execute(platformPlayer, GrimAPI.INSTANCE.getGrimPlugin(), () -> {
                this.noModifyPacketPermission = platformPlayer.hasPermission("grimnatorac.nomodifypacket");
                this.noSetbackPermission = platformPlayer.hasPermission("grimnatorac.nosetback");
