...
import com.grimnatorac.checks.impl.aim.AimDuplicateLook;
import com.grimnatorac.checks.impl.aim.AimLinearAssist;
import com.grimnatorac.checks.impl.aim.AimModulo360;
import com.grimnatorac.checks.impl.aim.AimSnapRetract;
import com.grimnatorac.checks.impl.aim.processor.AimProcessor;
import com.grimnatorac.checks.impl.badpackets.*;
import com.grimnatorac.checks.impl.breaking.*;
import com.grimnatorac.checks.impl.chat.ChatA;
import com.grimnatorac.checks.impl.chat.ChatB;
import com.grimnatorac.checks.impl.chat.ChatC;
import com.grimnatorac.checks.impl.chat.ChatD;
import com.grimnatorac.checks.impl.combat.*;
import com.grimnatorac.checks.impl.blockplace.Scaffold;
import com.grimnatorac.checks.impl.crash.*;
import com.grimnatorac.checks.impl.elytra.*;
import com.grimnatorac.checks.impl.exploit.ExploitA;
import com.grimnatorac.checks.impl.exploit.ExploitB;
import com.grimnatorac.checks.impl.groundspoof.NoFall;
import com.grimnatorac.checks.impl.misc.ClientBrand;
import com.grimnatorac.checks.impl.misc.GhostBlockMitigation;
import com.grimnatorac.checks.impl.misc.HealthObfuscation;
import com.grimnatorac.checks.impl.misc.OreObfuscation;
import com.grimnatorac.checks.impl.misc.Post;
import com.grimnatorac.checks.impl.misc.TransactionOrder;
import com.grimnatorac.checks.impl.misc.XRayAlert;
import com.grimnatorac.checks.impl.movement.NoSlow;
import com.grimnatorac.checks.impl.movement.PredictionRunner;
import com.grimnatorac.checks.impl.movement.AirStop;
import com.grimnatorac.checks.impl.movement.SetbackBlocker;
import com.grimnatorac.checks.impl.movement.VehiclePredictionRunner;
import com.grimnatorac.checks.impl.movement.VelocityAntiKB;
import com.grimnatorac.checks.impl.multiactions.*;
import com.grimnatorac.checks.impl.packetorder.*;
import com.grimnatorac.checks.impl.prediction.DebugHandler;
import com.grimnatorac.checks.impl.prediction.GroundSpoof;
import com.grimnatorac.checks.impl.prediction.OffsetHandler;
import com.grimnatorac.checks.impl.prediction.Phase;
import com.grimnatorac.checks.impl.scaffolding.*;
import com.grimnatorac.checks.impl.sprint.*;
import com.grimnatorac.checks.impl.timer.*;
import com.grimnatorac.checks.impl.vehicle.*;
import com.grimnatorac.checks.impl.velocity.ExplosionHandler;
import com.grimnatorac.checks.impl.velocity.KnockbackHandler;
import com.grimnatorac.checks.type.*;
import com.grimnatorac.events.packets.PacketChangeGameState;
import com.grimnatorac.events.packets.PacketEntityReplication;
import com.grimnatorac.events.packets.PacketPlayerAbilities;
import com.grimnatorac.events.packets.PacketWorldBorder;
import com.grimnatorac.manager.init.start.SuperDebug;
import com.grimnatorac.platform.api.permissions.PermissionDefaultValue;
import com.grimnatorac.player.GrimPlayer;
import com.grimnatorac.predictionengine.GhostBlockDetector;
import com.grimnatorac.predictionengine.SneakingEstimator;
import com.grimnatorac.utils.anticheat.update.*;
import com.grimnatorac.utils.latency.CompensatedCameraEntity;
import com.grimnatorac.utils.latency.CompensatedCooldown;
import com.grimnatorac.utils.latency.CompensatedFireworks;
import com.grimnatorac.utils.latency.CompensatedInventory;
import com.grimnatorac.utils.team.TeamHandler;
...
public class CheckManager {
    ...
    public CheckManager(GrimPlayer player) {
        ...
        // Shared instance for checks that implement multiple interfaces
        final AimSnapRetract aimSnapRetract = new AimSnapRetract(player);
        final AimLinearAssist aimLinearAssist = new AimLinearAssist(player);
...
//                .put(PacketOrderP.class, new PacketOrderP(player))
                ...
                .put(AimSnapRetract.class, aimSnapRetract)
                .put(HealthObfuscation.class, new HealthObfuscation(player))
                .put(OreObfuscation.class, new OreObfuscation(player))
                .put(AutoCrystal.class, new AutoCrystal(player))
                .put(AutoAnchor.class, new AutoAnchor(player))
                .put(TriggerBot.class, new TriggerBot(player))
                .put(KillAuraSync.class, new KillAuraSync(player))
                .put(SmoothAim.class, new SmoothAim(player)) // Detects smooth killaura with precision head snapping
                .put(HitboxCheck.class, new HitboxCheck(player)) // Replaces old Hitboxes stub - detects hitbox expansion via ray-box intersection
        ...
        rotationChecks = new ImmutableClassToInstanceMap.Builder<RotationCheck>()
                ...
                .put(AimLinearAssist.class, aimLinearAssist)
                .build();
        ...
        postPredictionChecks = new ImmutableClassToInstanceMap.Builder<PostPredictionCheck>()
                ...
                .put(AirStop.class, new AirStop(player)) // Detects air stop/freeze cheats
                ...
                .put(VelocityAntiKB.class, new VelocityAntiKB(player))
        ...
        blockPlaceChecks = new ImmutableClassToInstanceMap.Builder<BlockPlaceCheck>()
                ...
                .put(Scaffold.class, new Scaffold(player))
        ...
        blockBreakChecks = new ImmutableClassToInstanceMap.Builder<BlockBreakCheck>()
                ...
                .put(XRayAlert.class, new XRayAlert(player))
                .build();
    ...
    private void init() {
        ...
        final String[] permissions = {
                "grimnatorac.exempt.",
                "grimnatorac.nosetback.",
                "grimnatorac.nomodifypacket.",
        };
