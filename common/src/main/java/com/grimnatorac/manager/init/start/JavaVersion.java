...
public class JavaVersion implements StartableInitable {
    ...
    public void start() {
        ...
        if (version < 17) {
            ...
            LogUtil.warn("GrimnatorAC will no longer support this version of Java in a future release.");
            LogUtil.warn("See https://github.com/GrimnatorAC/GrimnatorAC/wiki/Updating-to-Java-17 for more information.");
        }
    }
}
