...
import com.grimnatorac.utils.nmsutil.BlockBreakSpeed;
...
@CheckData(name = "FastBreak", stableKey = "grimnatorac.breaking.fast_break", description = "Breaking blocks too quickly")
