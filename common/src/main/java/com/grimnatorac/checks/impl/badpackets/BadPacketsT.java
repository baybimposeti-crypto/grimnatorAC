...
@CheckData(name = "BadPacketsT", stableKey = "grimnatorac.badpackets.invalid_interact_vector")
public class BadPacketsT extends Check implements PacketCheck {
    ...
    public BadPacketsT(final GrimPlayer player) {
        ...
        // https://github.com/GrimnatorAC/GrimnatorAC/pull/1274#issuecomment-1872458702
        // https://github.com/GrimnatorAC/GrimnatorAC/pull/1274#issuecomment-1872533497
