...
@CheckData(name = "MultiInteractA", stableKey = "grimnatorac.multiinteract.multiple_targets", description = "Interacted with multiple entities in the same tick", experimental = true)
