...
import com.grimnatorac.checks.impl.multiactions.MultiActionsC;
...
@CheckData(name = "ChatC", stableKey = "grimnatorac.chat.moving_while_chatting", description = "Moving while chatting", experimental = true)
