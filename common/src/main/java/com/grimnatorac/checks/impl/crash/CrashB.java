...
@CheckData(name = "CrashB", stableKey = "grimnatorac.crash.creative_while_not_creative", description = "Sent creative mode inventory click packets while not in creative mode")
