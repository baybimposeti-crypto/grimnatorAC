...
import com.grimnatorac.utils.nmsutil.Ray;
...
@CheckData(name = "RotationPlace", stableKey = "grimnatorac.scaffolding.rotation_place", description = "Placed a block while not looking at it")
