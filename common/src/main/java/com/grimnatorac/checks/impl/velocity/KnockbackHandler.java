package com.grimnatorac.checks.impl.velocity;
...
@CheckData(name = "AntiKB", stableKey = "grimnatorac.velocity.anti_knockback", alternativeName = "AntiKnockback", configName = "Knockback", setback = 10, decay = 0.025)
