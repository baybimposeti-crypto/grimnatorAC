...
import static com.grimnatorac.utils.nmsutil.BlockBreakSpeed.getBlockDamage;

@CheckData(name = "WrongBreak", stableKey = "grimnatorac.breaking.wrong_break")
    ...
    public void onBlockBreak(BlockBreak blockBreak) {
        ...
        if (blockBreak.action == DiggingAction.CANCELLED_DIGGING) {
            ...
            if (!shouldExempt(blockBreak.block, pos.y) && !pos.equals(lastBlock)) {
                // https://github.com/GrimnatorAC/GrimnatorAC/issues/1512
