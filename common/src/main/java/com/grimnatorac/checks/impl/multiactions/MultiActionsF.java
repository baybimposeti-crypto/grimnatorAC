...
@CheckData(name = "MultiActionsF", stableKey = "grimnatorac.multiactions.block_and_entity_interact", description = "Interacting with a block and an entity in the same tick", experimental = true)
