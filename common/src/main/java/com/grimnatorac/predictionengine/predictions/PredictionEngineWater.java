...
public class PredictionEngineWater extends PredictionEngine {
    ...
    public void addJumpsToPossibilities(GrimPlayer player, Set<VectorData> existingVelocities) {
        for (VectorData vector : new HashSet<>(existingVelocities)) {
            // Swimming space vectors already include jump calculations, don't double-count
            boolean isSwimmingSpace = vector.vectorType == VectorData.VectorType.SwimmingSpace;
            ...
            } else if (!isSwimmingSpace) {
                // Don't add jump to swimming space vectors - they already have it calculated
