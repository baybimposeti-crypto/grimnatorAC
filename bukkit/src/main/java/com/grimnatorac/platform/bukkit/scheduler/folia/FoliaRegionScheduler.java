...
import com.grimnatorac.platform.bukkit.world.BukkitPlatformWorld;
...
public class FoliaRegionScheduler implements RegionScheduler {
    ...
    public void execute(@NotNull GrimPlugin plugin, @NotNull PlatformWorld world, int chunkX, int chunkZ, @NotNull Runnable task) {
        regionScheduler.execute(GrimnatorACBukkitLoaderPlugin.LOADER, ((BukkitPlatformWorld) world).bukkitWorld(), chunkX, chunkZ, task);
    }
