...
public class BukkitPermissionRegistrationManager implements PermissionRegistrationManager {
     ...
     * like "grimnatorac.exempt.checkname") that are generated at runtime. Most other static permissions
     * (e.g., "grimnatorac.exempt", "grimnatorac.alerts.enable-on-join") are registered with their defaults
     ...
     *
     * @param name         The permission node to register (e.g., "grimnatorac.exempt.checkname").
